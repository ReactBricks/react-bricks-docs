...
Before passing the page object to `PageViewer`, you need to parse it with the [`cleanPage`](../utilities/clean-page) utility function, which checks incoming blocks from the DB against your bricks schema and converts rich texts.
