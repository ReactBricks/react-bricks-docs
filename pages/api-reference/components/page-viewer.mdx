...
Before passing the page object to `PageViewer`, you need to parse it with the [`cleanPage`](/api-reference/utilities/clean-page) utility function, which check incoming blocks from the DB against your bricks schema and converts rich texts.
