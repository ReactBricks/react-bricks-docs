...
It manages authentication and renders the Admin menu. It acts also as a Provider for the [AdminContext](../context/admin-context), making it available to the wrapped components.
