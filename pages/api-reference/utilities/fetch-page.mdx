...
The fetchPage function is useful when you want to **retrieve the content of one page from outside the React context** (where you could use the [usePage hook](/api-reference/hooks/use-page) instead).
