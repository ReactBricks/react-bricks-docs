...
The fetchPages function is useful when you want to **retrieve all your tags from outside the React context** (where you could use the [useTagsPublic hook](/api-reference/hooks/use-tags) instead).
