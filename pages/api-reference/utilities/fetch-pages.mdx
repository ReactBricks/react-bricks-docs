...
The fetchPages function is useful when you want to **retrieve all your pages from outside the React context** (where you could use the [usePages hook](/api-reference/hooks/use-pages-public) instead).
