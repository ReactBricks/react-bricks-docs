...
The fetchPages function is useful when you want to **retrieve all your pages from outside the React context** (where you could use the [usePages hook](/docs-api/hooks/use-pages)).
...
The pages are of type [`Page`](/docs-api/types/#page), but without the content field.
