...
| Property             | Definition                                                                                                                                        |
| -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| `propName`           | Name of the prop containing the repeated items (should match the one in the [`repeaterItems` schema property](/docs/bricks/repeater-items))       |
...
<Repeater
  propName="buttons"
  renderWrapper={(items) => <div className="flex justify-center items-center">{items}</div>}
/>
```
