...
React Bricks underneath uses [Slate](https://docs.slatejs.org/) as a rich text editor. The `RenderElementProps` and `RenderLeafProps` are types from Slate. See [Slate rendering docs](https://docs.slatejs.org/concepts/09-rendering)
