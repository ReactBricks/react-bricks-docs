...
<Video src="/videos/RB_CLI_opt.mp4" />
...
When the app starts, we suggest that you explore the [Admin Dashboard](react-bricks-dashboard), going to the `/admin` path or clicking on the "Edit content" button in the header menu.  
