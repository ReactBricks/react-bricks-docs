...
4. Choose a [Starter project](/docs/getting-started/starter-projects)
...
When the app starts, we suggest that you explore the [Admin Dashboard](/docs/getting-started/admin-dashboard), going to the `/admin` path or clicking on the "Edit content" button in the header menù.
...
- The first configuration step could be setting your logo for the Admin header. See [Configuration](/docs/getting-started/configuration)
- Then you could start creating your first content blocks (bricks). See [What is a brick](/docs/bricks/brick-definition)