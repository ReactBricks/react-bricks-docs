...
| `validate`          | Validation function. The value is valid if the function returns `true`. If the returned value is a string, it is considered as an error message.<br /><br />You can use the value of this prop, or, if you need it, you may access all the props' values using the second argument (which gets an object with all the key-value props).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
