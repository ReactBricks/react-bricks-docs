...
| `allowedFeatures` | An array of allowed rich text features: the available features are `BOLD`, `ITALIC`, `CODE`, `HIGHLIGHT`, `LINK`, `UL`, `OL`.<br /><br />You find them on the exported `types.RichTextFeatures` |
