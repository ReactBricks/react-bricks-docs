...
| `customFields` | Array of custom fields or groups of custom fields on a Page, modified via the sidebar's "Document" tab. See [Custom fields](custom-fields) |
...
| `responsiveBreakpoints` | Optional responsive breakpoints for preview. Defaults to `375px`, `768px` and `100%`. Array of objects having the [BreakPoint](/api-reference/types/interfaces#responsivebreakpoint) interface.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `enableAutoSave`        | `false` by default. If you enable it, the user will be able to activate autosave using a switch near the Save button                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
