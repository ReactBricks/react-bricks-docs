...
| `clickToEditSide`  | The corner where to render the "click-to-edit" button in the Viewer. The enum values are "BOTTOM-RIGHT" (`types.ClickToEditSide.BottomRight`), "BOTTOM-LEFT" (`types.ClickToEditSide.BottomLeft`), "TOP-RIGHT" (`types.ClickToEditSide.TopRight`), "TOP-LEFT" (`types.ClickToEditSide.TopLeft`).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
