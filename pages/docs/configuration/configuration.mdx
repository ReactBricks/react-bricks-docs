...
| `clickToEditSide`  | The corner where to render the button to edit content in the front-end. The enum values are "BOTTOM-RIGHT" (`types.ClickToEditSide.BottomRight`), "BOTTOM-LEFT" (`types.ClickToEditSide.BottomLeft`), "TOP-RIGHT" (`types.ClickToEditSide.TopRight`), "TOP-LEFT" (`types.ClickToEditSide.TopLeft`).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
