...
Custom fields can be configured on:

- [React Bricks configuration](configuration): they are applied to all pages
- [pageTypes](page-types): they are applied only to a specific page type
