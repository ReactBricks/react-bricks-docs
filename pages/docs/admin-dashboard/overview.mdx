...
- [**App Settings / Deploy**](app-settings): here the Editor can trigger a rebuild of the static website (if hosted on Netlify or Vercel). The Admin may configure the App Name, Deploy configuration and Users.
