...
- **Document**: where you can edit [page properties](/docs/admin-dashboard/pages), like Name, Slug, Meta attributes (title, description, featured image, author, tags), set the [status of the page](/docs/admin-dashboard/pages) (draft / published, locked / unlocked), delete the page.
